...
This project doesn't have an explicit Code of Conduct (yet). Please report unacceptable behavior to the [project authors/maintainers](pyproject.toml).


## I Have a Question

> If you want to ask a question, you should ask a question!

Before you ask a question, it is best to search for existing [Issues](../../issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the universe and within yourself for answers first. Should you find the answer, consider contributing to make that answer more apparent to future users.

If you still wish to ask a question and/or would like clarification, we recommend the following:

- Open an [Issue](../../issues/new).
- Provide as much context as you can about what you're running into.
- Provide project, platform, and driver versions, depending on what seems relevant.
- Live life.
...
- Also make sure to search the universe to see if users outside of the GitHub community have discussed the issue.
...
- PRs, once reviewed and approved, should be resolved by squash and merge
```sh
> pixi shell
> pre-commit install
...
This project doesn't have documentation (yet). You could start by creating the documentation!
